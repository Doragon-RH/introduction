...
FP2級取得後に、相談受付状況、正式な料金、予約導線などを更新します。サービス開始後の最初の5名程度は、相談後アンケートに協力いただける方を対象とした初期モニターとして、大幅割引・料金応相談を想定しています。月間件数などの個人的な目標は公開情報には含めません。個別具体的な税務判断や特定金融商品の売買推奨を提供するサービスとしては表示しません。
